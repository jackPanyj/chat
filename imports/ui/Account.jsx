...
class Account extends Component {
  ...
  handleSubmit(e) {
    ...
    HTTP.call('get', url, (err, res) => {
      err ? console.log(err) : this.setState({user: JSON.parse(res.content)})
    })
  }

  handleClick(e) {
    e.preventDefault()
    Meteor.call('update/user', this.state.user, (err) => {
      err ? console.log(err) : this.context.router.push('/chat')
    })
  }
